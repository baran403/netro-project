...
export default function TamamlananProjeler() {
  ...
  const projects = allProjects?.filter(project => project.status === "Biten");
          ...
          <div className="container mx-auto px-4">
            ...
            <nav className="text-sm mb-8">
              <ol className="flex items-center space-x-2">
                ...
                <li className="text-gray-300">/</li>
                <li className="text-white">Tamamlanan Projeler</li>
              </ol>
            </nav>

            <div className="max-w-3xl">
              <h1 className="text-4xl lg:text-5xl font-bold mb-6">Tamamlanan Projeler</h1>
              <p className="text-xl text-gray-300 leading-relaxed">
                Başarıyla tamamladığımız projelerimizi inceleyin.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-light-gray">
          <div className="container mx-auto px-4">
            ...
            {isLoading ? (
              ...
              <div className="text-center py-12">
                <p className="text-gray-600 text-lg">Henüz tamamlanmış proje bulunmamaktadır.</p>
                <Link href="/projeler">
